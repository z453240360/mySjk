package com.dd.mylibrary.wedget.toasty;
 ...
 * <p>
 * You should have received selector_sort_rate_back copy of the GNU General Public License
...
public class Toasty {
   ...
   private static Toast toast;
    ...
    Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                 @ColorInt int textColor, @ColorInt int tintColor, int duration,
                 boolean withIcon, boolean shouldTint) {
        final Toast currentToast = getInstance(context);
