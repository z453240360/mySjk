...
public class LogUtils {
    ...
    private static Boolean MYLOG_WRITE_TO_FILE = Constant.showDebug;// 日志写入文件开关
    private static char MYLOG_TYPE = 'v';// 输入日志类型，w代表只输出告警信息等，v代表输出所有信息
    private static String MYLOG_PATH_SDCARD_DIR = ROOT_PATH + "/Insurance/";// 日志文件在sdcard中的路径
    ...
    private static void log(String tag, String msg, char level) {
        if (BasicConfig.LOGGING && msg != null) {
